 ...
 */
public class ConsultaTrabajador implements Comando {
	/** 
	 * <!-- begin-UML-doc -->
	 * <!-- end-UML-doc -->
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	...
	public CommandResponse ejecutar(Object datos) {
		...
		try {
			...
			cr.setEvento(IDEventos.EVENTO_CONSULTA_TRABAJADOR);

		} catch (SQLException excep) {

			cr.setDatos(excep);
			cr.setEvento(IDEventos.ERROR_EVENTO_CONSULTA_TRABAJADOR);
		} 

 ...
 */
public class ActualizarDepartamento implements Comando{
	/** 
	 * <!-- begin-UML-doc -->
	 * <!-- end-UML-doc -->
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	...
	public CommandResponse ejecutar(Object datos) {
		...
		try {
			...
			cr.setDatos(FactorySA.getInstance().getSADepartamento().actualizarDepartamento((TransferDepartamento) datos));
